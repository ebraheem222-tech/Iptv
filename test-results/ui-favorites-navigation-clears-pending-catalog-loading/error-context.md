...
- Name: ui.spec.js >> favorites navigation clears pending catalog loading
- Location: tests\ui.spec.js:85:1
...
Call log:
  - waiting for getByRole('button', { name: 'Favorites', exact: true })
